...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-pqfoo#m&!p@&9i#ik6u%^b49v&ic)i5=(aw!)_uk0mj=ysnw7)")
...
# Use PostgreSQL from DATABASE_URL if available (for production)
